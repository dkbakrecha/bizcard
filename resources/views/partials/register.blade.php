...
<div class="container">
    ...
    <form method="POST" id="registerSP" action="{{ route('register') }}" class="biz-form"  enctype="multipart/form-data">
        ...
        <div class="form-group row mb-0">
            <div class="col-md-12">
                <center>
                    <p class="textTerm">By signing up, you’re okay with our Terms of Service, Privacy Policy, and our default Notification Settings.</p>
        ...
        <div class="row">
            <div class="col-xs-12 verify center">
                <a href="{{ route("login") }}">Already have an account? <b>Log In</b></a>
            </div>
        </div>
    </form>        
        </div>
